...
@WebServlet(name = "aggiungiCommentoServlet", value = "/aggiungiCommentoServlet")
public class AggiungiCommentoServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        if(u!=null && u.getRuolo().equalsIgnoreCase("u"))
        {
            ...
            commentoDAO.doInsertCommento(c);
